    ...
    try {
        ...
        function save() {
            ...
            const datos = new CachingCliente({
                ...
                CLVA_CELULAR:  clienteVOResponse.clienteVOResponse.CLVA_CELULAR,
                CLVA_EMAIL:  clienteVOResponse.clienteVOResponse.CLVA_EMAIL,
...
export async function searchClient3(req: any, res: any) {
    try {
        console.log('Cliente: ' + req.body.documento);
        codTok='eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImtpZCI6IlFqTkdSVUUyT1VWRU1UQTJSVGt3TmpBd09EWTRNelE0UVRoRU1FSkVOVGd5T1RaQ1JFRXdRZyJ9..p6xgrg_EpagXVV6pHj_U7tdZHjQOfYDyEZC44Vb34yAVQcgttVIad100lj52qYVNSo6tMCMCyx-8N3yXqA-zZzvN-XQJl10jfjulS1iA7D0SSG9bw9zSHjI_YP6-CWbpY_wMOSathgwKb2rHCnevcu7mll99EftcoM901RZ-JQF_1kBdCvjgT7U7Tzou4KhbdiCLHgxe3SdyLt3ZqtShqUwKLN0FSPQKxveFNu70qBWLqClkaUOs9Nwe0l9MV0SWHEiYdS7LxToMLX2zlOi150Y6YcdYM6ok4GR4McsZcp3evBjN2je2ZFACPcO65w69tmgHQcAi7i3O0GfoZOexrQ';
        return new Promise((res, rej) => {
            getToken().then((data) => {
                Request.get({
                    "headers": {
